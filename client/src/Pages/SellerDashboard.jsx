...
const SellerDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar - Fixed */}
      <div
        className={`fixed top-0 left-0 h-full bg-gradient-to-b from-[#3F0AAD] to-[#2D077A] text-white flex flex-col p-0 shadow-xl z-20 transition-all duration-300 ease-in-out ${
          ...
          <ul className="space-y-1">
            ...
            <li>
              <Link
                ...
                />
                {sidebarOpen && <>{t("sellerDashboard.sidebar.products")}</>}
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <Link
                ...
                />
                {sidebarOpen && <>{t("sellerDashboard.sidebar.orders")}</>}
              </Link>
            </li>
