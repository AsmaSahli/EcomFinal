...
const stripePromise = loadStripe(
  "pk_test_51RXB8eR0JuzwW2NjHpnGlvorMUFn3PHqq57fFASeLWm7jL4oT4CdvOYRfVJdEgNNscQmkwXA0TXAAOA14ifTEfzn00FulqPdkB"
);
const CheckoutPage = () => {
    ...
    try {
      ...
      const orderData = {
        ...
        items: cartItems.map((item) => ({
          ...
          price: item.price,
          promotion: item.promotion ? item.promotion.promotionId._id : null,
        })),
        shippingInfo: {
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows="2"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"></textarea>
                  </div>
                </div>
              </motion.div>
            )}
