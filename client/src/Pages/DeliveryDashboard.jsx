...
const DeliveryDashboard = () => {
  ...
  const username =
    currentUser?.email.split("@")[0] || t("deliveryDashboard.role");
    ...
    <div className="flex min-h-screen bg-gray-50">
            ...
            <li>
              <Link
                ...
                className={`flex items-center px-4 py-3 rounded-lg ${
                  activeTab === "dashboard"
                    ? "bg-[#4A12C4] text-white font-medium"
                    : "hover:bg-[#4A12C4] hover:text-white"
                } transition`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                aria-label={t("deliveryDashboard.notifications.new")}></button>

              <div className="flex items-center space-x-2">
                <div className="text-right hidden md:block">
                  <div className="font-medium text-gray-800">{username}</div>
                  <div className="text-xs text-gray-500">
                    {t("deliveryDashboard.role")}
                  </div>
                </div>
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-gray-50">
          {activeTab === "dashboard" && (
            <DashOverview deliveryData={deliveryData} />
          )}
          {activeTab === "deliveries" && (
            <DashMyDeliveries deliveries={deliveryData.currentDeliveries} />
          )}
          {activeTab === "assigned" && <DashAssignedDeliveries />}
          {activeTab === "history" && (
            <DashDelivreyHistory deliveries={deliveryData.recentDeliveries} />
          )}
