    ...
    <motion.div
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <div
            className={`mt-4 inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${statusSteps[currentStatusIndex].color}`}>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {order.suborders.map((suborder) => {
              const suborderStatusIndex = statusSteps.findIndex(
                (step) => step.id === suborder.status
              );
                ...
                <div
                  ...
                  <div
                    ...
                    <div className="flex items-center">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${suborderStatus.color}`}>
                        {suborderStatus.icon}
                      </div>
                      <div className="ml-3">
                        <h3 className="font-medium text-gray-800">
                          {t("orderTracking.seller")}:{" "}
                          {suborder.sellerId?.shopName ||
                            t("orderTracking.seller")}
                        </h3>
                        <p className="text-sm text-gray-500">
                          {suborder.items.length} {t("orderTracking.items")} • $
                    ...
                    <div className="flex items-center">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${suborderStatus.color}`}>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="text-sm text-gray-600 space-y-3">
                  ...
                  <div>
                    ...
                    <p>
                      {t(
                        `orderTracking.deliveryMethods.${order.deliveryMethod}`
                      )}
                    </p>
                  </div>
                  <div>
