    ...
    const fetchReviews = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_URL}/reviews/${productId}/${sellerId}`
        );
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-2">
            <h3 className="text-lg font-medium text-gray-900 mb-4">
              {t("productReviews.summary.breakdown")}
            </h3>
            <div className="space-y-2">
              {ratingDistribution.map((count, index) =>
                renderRatingBar(count, index)
              )}
            </div>
          </div>
        </div>
        ...
        <div className="text-center py-12 bg-white rounded-2xl shadow-sm border border-gray-100">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">
              {t("productReviews.noReviews.title")}
            </h3>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="font-semibold text-gray-900">
                        {review.user?.name ||
                          t("productReviews.review.anonymous")}
                      </h4>
                      ...
                      <div className="flex space-x-3">
                        ...
                        <button
                          onClick={() => {
                            if (
                              window.confirm(
                                t("productReviews.review.deleteConfirm")
                              )
                            ) {
                    ...
                    <form onSubmit={handleUpdateReview} className="mt-4">
                      <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">
                          {t("productReviews.form.ratingLabel")}
                        </label>
                        {renderRatingInput(editForm.rating, (rating) =>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-indigo-800">
                {t("productReviews.review.alreadyReviewed")}
              </h3>
