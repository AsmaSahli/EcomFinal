        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-purple-100">
              You have {currentDeliveries.length} active deliveries today
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="mt-4 flex items-center text-sm text-green-500">
            <span>
              {currentDeliveries.filter((d) => d.status === "pending").length}{" "}
              new assignments
            </span>
          </div>
        </div>
              ...
              currentDeliveries.slice(0, 3).map((delivery) => (
                <div
                  ...
                  <div className="mt-3 flex justify-between items-center">
                    ...
                    <button
                      onClick={() =>
                        navigate("/delivery-dashboard?tab=assigned")
                      }
                      className="text-sm text-[#3F0AAD] font-medium hover:underline">
                      View Details
                    </button>
              ...
              recentDeliveries.map((delivery) => (
                <div
                  ...
                  <div className="mt-3 flex justify-between items-center">
                    ...
                    <button
                      onClick={() =>
                        navigate("/delivery-dashboard?tab=history")
                      }
                      className="text-sm text-[#3F0AAD] font-medium hover:underline">
                      View Details
                    </button>
