...
const METABASE_SECRET_KEY =
  "a0c561f13d99ba395a05e50a6b0ed47102c97459335923a8a3a97840c59101cb";
...
app.get("/api/metabase-embed-token/:dashboardId", (req, res) => {
  try {
    ...
    if (!allowedDashboards.includes(dashboardId)) {
      return res
        .status(403)
        .json({ success: false, message: "Unauthorized dashboard access" });
    }
    ...
    res
      .status(500)
      .json({ success: false, message: "Failed to generate embed URL" });
  }
});
